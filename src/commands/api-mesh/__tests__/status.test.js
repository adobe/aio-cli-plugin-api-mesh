...
describe('status command tests', () => {
	...
	describe('unexpected error', () => {
		test('should output mesh not found error when mesh does not exist', async () => {
			...
			const expectedMessage = `Unable to get mesh status. No mesh found for Org(${mockOrg.code}) -> Project(${mockProject.id}) -> Workspace(${mockWorkspace.id}). Please check the details and try again.`;
