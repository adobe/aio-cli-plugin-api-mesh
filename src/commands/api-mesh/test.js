...
const { fetchLogs, getTenantFeatures } = require('../../lib/devConsole');
...
class LogCommand extends Command {
	...
	async run() {
		...
		try {
			const meshDetails = await fetchLogs(imsOrgId, projectId, workspaceId, workspaceName);
...
LogCommand.description = 'Get details of a mesh';
